...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'nav.about': 'About us',
    'nav.contact': 'Contact',
    'nav.open_dates': 'Open Dates',
    'open_dates.title': "When We're Open",
    'open_dates.open_note': 'Karabina is open December through March each winter season.',
    'open_dates.closed_label': 'Closed',
    'open_dates.upcoming': 'Upcoming Season',
    'open_dates.current': 'Current Season',
  ...
  jp: {
    ...
    'nav.contact': 'お問い合わせ',
    'nav.open_dates': '営業日',
    'open_dates.title': '営業期間',
    'open_dates.open_note': 'カラビナは毎年12月〜3月の冬季に営業しています。',
    'open_dates.closed_label': '休業日',
    'open_dates.upcoming': '次のシーズン',
    'open_dates.current': '今シーズン',
    ...
    'footer.daily': '不定期営業',
    'footer.check_calendar': '営業日はカレンダーでご確認ください →',
